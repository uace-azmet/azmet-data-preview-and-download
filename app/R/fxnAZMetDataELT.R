...
fxnAZMetDataELT <- function(station, timeStep, startDate, endDate) {
  ...
  if (timeStep == "Daily") {
    ...
    varsID <- 
      c("meta_station_name", "meta_station_id", "meta_version", "datetime", "date_year", "date_doy")
